  ...
  return (
    <>
      <Head>
        ...
        <title>Kanat Nazarov | Senior Full-Stack Developer & AI Systems Engineer</title>
        <meta
          name="description"
        ...
        <meta property="og:url" content={`https://kanatnazarov.vercel.app${router.asPath}`} />
        <meta property="og:title" content="Kanat Nazarov | Senior Full-Stack Developer & AI Systems Engineer" />
        <meta
        ...
        />
        <meta property="og:image" content="https://kanatnazarov.vercel.app/og-image.jpg" />
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />

        {/* Global Twitter Card Protocol Schema */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Kanat Nazarov | Senior Full-Stack Developer" />
        <meta
          name="twitter:description"
          content="Architecting ultra-low latency full-stack systems with Next.js, NestJS, and TypeScript."
        />
        <meta name="twitter:image" content="https://kanatnazarov.vercel.app/og-image.jpg" />
      </Head>
