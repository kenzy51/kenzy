  ...
  return (
    <Html lang="en">
      <Head>
        ...
        {/* Core SEO */}
        <title>Kanat Nazarov | Full-Stack Developer & Software Engineer | NYC</title>
        <meta
          name="description"
        ...
        <meta property="og:title" content="Kanat Nazarov | Full-Stack Developer NYC" />
        <meta
        ...
        />
        <meta property="og:image" content="https://kenzy.vercel.app/og-image.jpg" /> {/* Add this image */}
        ...
        <meta name="twitter:title" content="Kanat Nazarov | Full-Stack Developer NYC" />
        <meta name="twitter:description" content="Full-Stack Developer in NYC | Next.js, React, NestJS" />
        <meta name="twitter:image" content="https://kenzy.vercel.app/og-image.jpg" />
