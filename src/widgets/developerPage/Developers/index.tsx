    ...
    if (!hasLoadedBefore) {
      ...
      masterTimeline.to(progressObj, {
        ...
        onUpdate: () => {
          ...
          if (currentProgress > 30 && videoRef.current && videoRef.current.paused) {
                  ...
                  <div className="bio-card relative group rounded-2xl overflow-hidden bg-gradient-to-b from-neutral-900/40 to-neutral-950/80 border border-neutral-800/60 p-5 shadow-2xl transition-all duration-300 hover:border-cyan-500/20">
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <a href="https://drive.google.com/file/d/1WsO4PQ5_DxbwlAMdbFjXmJKyiVI1uLBh/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="h-8 px-3 rounded-lg bg-neutral-900/80 border border-neutral-800/80 flex items-center justify-center text-[10px] font-mono font-bold text-neutral-400 transition-all hover:bg-neutral-800 hover:text-white">
                          CV
                        </a>
                      </div>
                    </div>
